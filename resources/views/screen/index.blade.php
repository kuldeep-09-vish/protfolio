...
<section id="hero" class="hero section dark-background">
    ...
    <!-- <img src="{{asset('uploads/about_images/'. $aboutdata->about_image)}}" alt="" data-aos="fade-in" class=""> -->

    <div class="container" data-aos="fade-up" data-aos-delay="100">
        <h2>{{$admindata->name}}</h2>
        <p>I'm <span class="typed" data-typed-items=" Wordpress Developer, Laravel Developer, Freelancer, Desginer">
                    ...
                    <div class="col-lg-6">
                        <ul>
                            <li><i class="bi bi-chevron-right"></i> <strong>Age:</strong>
                                <span>{{$admindata->age}}</span></li>
                            <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong>
                                <span>{{$admindata->degree}}</span></li>
                            <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong>
                                <span>{{$admindata->email}}</span>
                            </li>
                            <li><i class="bi bi-chevron-right"></i> <strong>Freelance:</strong>
                                <span>{{$admindata->freelance}}</span>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row skills-content skills-animation">
            ...
            <div class="col-lg-6">
                ...
                <div class="progress">
                    <span class="skill"><span>{{$adminskill->skill_name}}</span> <i
                            class="val">{{$adminskill->skill_percent}}%</i></span>
                    <div class="progress-bar-wrap">
                        <div class="progress-bar" role="progressbar" aria-valuenow="{{$adminskill->skill_percent}}"
